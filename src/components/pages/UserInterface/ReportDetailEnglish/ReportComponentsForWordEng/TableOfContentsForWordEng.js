...
function TableOfContentsForWordEng({ refs }) {
    ...
    const sections = [
        ...
        { title: "SECTION 6 - Physical / Building and Land Information of the Real Estate", subSections: [], page: 8, },
        { title: "SECTION 7 - SWOT Analysis", subSections: [], page: 9, },
        { title: "SECTION 8 - Valuation Methodology", subSections: [], page: 10 },
        { title: "SECTION 9 - Evaluation of Analysis Results", subSections: [], page: 11 },
        { title: "SECTION 10 - Conclusion", subSections: [], page: 12, },
        { title: "SECTION 11 - Appendices", subSections: [], page: 13, }
    ];
    ...
    return (
        <Box
            ...
            boxShadow="lg">
            <Text mb="50px" display="flex" justifyContent="center" style={{ fontFamily: "Roboto, sans-serif", fontSize: "20px", fontWeight: "bold" }}>TABLE OF CONTENTS</Text>
...
export default TableOfContentsForWordEng;
