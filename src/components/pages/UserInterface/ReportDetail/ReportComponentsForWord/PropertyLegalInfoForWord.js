const PropertyLegalInfoForWord = ({ info }) => {
    ...
    return (
        <div style={{ padding: '16px' }}>
            <h1 style={{ fontWeight: 'bold', fontSize: '24px', margin: '16px 0' }}>BÖLÜM 4 - GAYRİMENKULLERİN MÜLKİYET HAKKI VE İMAR BİLGİLERİ / GAYRİMENKULÜN YASAL DURUMUNA İLİŞKİN BİLGİLER / YASAL VE İMAR BİLGİLERİ:</h1>
