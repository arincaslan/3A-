...
function CoverPageForWord({ info, profileInfo }) {
        ...
        <div>
            ...
            >
                <div style={{ textAlign: "center", alignItems:"center", display:"flex", flexDirection:"column" }}>
                    ...
                    <h1 style={{ fontFamily: "Roboto, sans-serif", fontSize: "40px", fontWeight: "bold", color: "teal" }}>GAYRİMENKUL DEĞERLEME RAPORU</h1>
...
export default CoverPageForWord;
